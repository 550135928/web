				...
				<div class="food-content">
					...
					<div class="content">
						...
						<transition name='fade'>
							<div class="buy" v-show='!food.count||food.count===0' @click.prevent='addFirst'>加入购物车</div>
						</transition>
					</div>
...
<script>
  ...
  export default {
    ...
    created () {
      this.$root.eventHub.$on('ratingtypeSelect', this._ratingtypeSelect)
      this.$root.eventHub.$on('contentToggle', this._contentToggle)
    },
    methods: {
      show () {
        this.showFlag = true
